            ...
            <div class="container-fluid align-items-center">
                ...
                <map name="image-map">
                    ...
                    @foreach($locations as $location)
                        <area target="" alt="" title="@foreach($location->tecnicos as $tecnico) {{$tecnico->user->name}}@endforeach" href="{{route('whoIsOnLocation',$location->id)}}" coords="{{$location->coord}}" shape="rect">
                    @endforeach
